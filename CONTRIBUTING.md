...
arg the path to `base16-conemu` repository: `./base16-builder-go
-template-dir ../base16-conemu`

Or the above steps represented in shell commands:

```shell 
cd /path/to/base16-conemu/../ # This repos parent dir 
...
base16-builder-go \
  ...
  -template-dir /path/to/base16-conemu
```
